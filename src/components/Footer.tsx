  ...
  return (
    <footer className="bg-theme-section border-t border-theme-section backdrop-blur-md py-16 sm:py-20 px-6 sm:px-10 lg:px-16 text-zinc-400 select-none">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-16">
        ...
        <div className="space-y-5">
          <div>
            <h4 className="font-bold text-theme-page text-xs uppercase tracking-widest">Quick Navigation</h4>
            <div className="h-[2px] w-6 dark:bg-zinc-800 bg-zinc-200 mt-2 rounded-full"></div>
          </div>
        ...
        <div className="space-y-5">
          <div>
            <h4 className="font-bold text-theme-page text-xs uppercase tracking-widest">Tracked Stores</h4>
            <div className="h-[2px] w-6 dark:bg-zinc-800 bg-zinc-200 mt-2 rounded-full"></div>
          </div>
        ...
        <div className="space-y-5">
          <div>
            <h4 className="font-bold text-theme-page text-xs uppercase tracking-widest">Support & Contact</h4>
            <div className="h-[2px] w-6 dark:bg-zinc-800 bg-zinc-200 mt-2 rounded-full"></div>
          </div>
          <p className="text-xs leading-relaxed text-zinc-500 font-medium">
      ...
      {/* Copyright & Legal */}
      <div className="max-w-7xl mx-auto pt-10 border-t border-theme-section flex flex-col md:flex-row items-center justify-between gap-6 text-[10px] sm:text-xs text-zinc-500 font-bold uppercase tracking-widest">
